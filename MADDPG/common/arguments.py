...
def get_args():
    ...
    parser.add_argument("--max-episode-len", type=int, default=80, help="maximum episode length")
    parser.add_argument("--time-steps", type=int, default=10000000, help="number of time steps")
    ...
    parser.add_argument("--evaluate-rate", type=int, default=3000, help="how often to evaluate model")
    parser.add_argument("--load_model", type=bool, default=False, help="load model to continue")
